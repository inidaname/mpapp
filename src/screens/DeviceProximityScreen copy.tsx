...
import { addOfflineTransaction, resetOfflineTransactions } from '../store/reducers/offline-transactions';
...
const DeviceProximityScreen: React.FC<Props> = ({ navigation }) => {
  ...
  // 1. Get transactions from Redux
  // We use [ ...transactions ].reverse() to show newest first in the list
